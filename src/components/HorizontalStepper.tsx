      ...
      <div className="flex w-full h-full relative overflow-hidden">
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              <div className="flex-1 flex bg-white rounded-xl shadow-sm border border-gray-200 h-full w-15/20 min-h-[400px]">
...
export const HorizontalStepper: React.FC<StepperProps> = ({ steps, currentStep, onStepChange }) => {
  const getStepStatus = (index: number): StepStatus => {
    if (index < currentStep) return StepStatus.COMPLETED;
    if (index === currentStep) return StepStatus.CURRENT;
    return StepStatus.UPCOMING;
  ...
  return (
    <div className="flex flex-col h-full w-full mx-auto p-6">
      ...
      {/* Step Content */}
      <div className="flex w-full h-full relative bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden p-4 mb-4">
