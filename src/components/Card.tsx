...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <div 
      className={`w-56 bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg ${className}`}
    >
        ...
        <div className="flex justify-between mt-0 gap-2">
          ...
          {onDelete && (
            <div
              ...
              className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200"
